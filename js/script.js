...
// let arr = [ 'Dog', { name: 'Natalia' }, true, function() { alert('hi'); } ];
// // получить элемент с индексом 0
// alert( arr[0] );
...
// let students = ["Natasha", "Ira", "Yara"];
//
// students.push("Vika", "Sveta");
// students.unshift("Vnja", "Juli");
// alert( students );
//
//
//
//
// let students = ["Natasha"];
// let arr = students;
// alert( arr === students );
// arr.push("Ira");
// alert( students );
